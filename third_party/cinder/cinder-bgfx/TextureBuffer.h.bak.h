...
namespace cinder { namespace mtl {
    ...
    using TextureBufferRef = std::shared_ptr<class TextureBuffer>;
    ...
    public:
        ...
        public:
            ...
            Format& textureType( bgfx::TextureFormat textureType ) { setTextureType( textureType ); return *this; };
            void setTextureType( bgfx::TextureFormat textureType ) { mTextureType = textureType; };
            
            bgfx::TextureFormat getTextureType() const { return mTextureType; };
        ...
        protected:
            ...
            bgfx::TextureFormat mTextureType;
        ...
        TextureBufferRef newTexture( bgfx::TextureFormat fmt, uint levelOffset = 0,
