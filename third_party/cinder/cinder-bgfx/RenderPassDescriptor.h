...
namespace cinder { namespace mtl {
    ...
    using RenderPassDescriptorRef = std::shared_ptr<class RenderPassDescriptor>;
    ...
    public:
        ...
        protected:
            bool mShouldClearColor{ true };
            ci::ColorAf mClearColor;
            StoreAction mColorStoreAction;
            
            bool mHasDepth{ true };
            bool mShouldClearDepth{ true };
    ...
    protected:
        ...
        void * mImpl{ nullptr }; // MTLRenderPassDescriptor *
        void * mDepthTexture{ nullptr }; // <MTLTexture>
        void * mStencilTexture{ nullptr }; // <MTLTexture>
